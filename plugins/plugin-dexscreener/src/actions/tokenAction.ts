...
export const priceTemplate =
  `Determine if this is a token price request. If it is one of the specified situations, perform the corresponding action:
...
export class TokenPriceAction implements Action {
  ...
  examples = [[{ user: '{{user}}', content: { text: 'check price of eth' } }, {
    ...
    content: {
      text:
        'The current price of Ethereum (ETH) is $2,345.67 with a 24h trading volume of $9.87B. The liquidity pool holds $1.23B, and the price has changed +5.43% in the last 24 hours.',
    ...
    content: {
      text:
        "Bitcoin (BTC) is currently trading at $42,567.89. There's $15.23B in liquidity, with a 24h volume of $25.87B. The price is up 2.15% in the last 24 hours.",
      action: 'GET_TOKEN_PRICE'
    }
    ...
    content: {
      text:
        'Binance Coin (BNB) is priced at $345.67 with $5.23B in liquidity. The trading volume over the last 24h is $1.87B, and the price has decreased by 1.23% during this period.',
      action: 'GET_TOKEN_PRICE'
    }
    ...
    content: {
      text:
        'Tether (USDT) is maintaining its peg at $1.00 with minimal change (+0.01%). The token has $25.23B in liquidity and has seen $45.87B in trading volume over the past 24 hours.',
      action: 'GET_TOKEN_PRICE'
    }
    ...
    content: {
      text:
        'Solana (SOL) is trading at $123.45, showing strong momentum with an 8.75% increase in the last 24 hours. The liquidity stands at $3.23B with a 24h trading volume of $987.54M.',
      action: 'GET_TOKEN_PRICE'
    }
    ...
    content: {
      text:
        'The price of Polygon (MATIC) is currently $1.23, up 3.45% in the past 24 hours. The token has $2.23B in liquidity and has seen $567.54M in trading volume today.',
      action: 'GET_TOKEN_PRICE'
    }
  }]];
}
