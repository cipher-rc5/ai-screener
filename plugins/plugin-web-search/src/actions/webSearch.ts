import { type Action, elizaLogger, type HandlerCallback, type IAgentRuntime, type Memory, type State } from '@elizaos/core';
...
function getTotalTokensFromString(str: string, encodingName: TiktokenModel = DEFAULT_MODEL_ENCODING) {
